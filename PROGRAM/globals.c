...
#include "sound.c"
string savefile_info = "ver 1.7.3";
// --------- DLC globals ---------------------------------------------
...
#define DLC_NAME_1        "The Caleuche"
#define DLC_NAME_2        "The Final Lesson"
#define DLC_NAME_3        "Flying the Jolly Roger"
#define DLC_NAME_4        "Hero of the Nation"
#define DLC_NAME_5        "Happily Ever After"
#define DLC_NAME_6        ""
