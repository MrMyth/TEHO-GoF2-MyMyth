...
void SetVariable()
{
	...
	sText = sti(colonies[iColony].crew);
	sText = sText + " ";
...
void Build()
{
	...
	XI_WindowShow("BUILD_CONFIRM", true);
	XI_WindowDisable("BUILD_CONFIRM", false);
	string sText = "�� �������, ��� ������ ��������� " + ColonyUpgrades[iUpgradeNum].name + ", �������� " + ColonyUpgrades[iUpgradeNum].(sLevel).money + "?";
...
void ChangeHovernor()
{
	...
	CreateGovernor(&characters[charidx], sColony);
	FillPassengerScroll();
