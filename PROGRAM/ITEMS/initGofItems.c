...
int GofInitItems()
{
	...
	*/
	...
	n = initStdBlade(n, "GOF_blade9", "ITEMS_GOF3", 2, TGT_OFFICER, B_ORDINARY, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 300);
	n = initStdBlade(n, "GOF_blade14", "ITEMS_GOF3", 7, TGT_OFFICER, B_ORDINARY, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 200);
	n = initStdBlade(n, "GOF_blade19", "ITEMS_GOF3", 12, TGT_OFFICER, B_ORDINARY, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 350);
	n = initStdBlade(n, "GOF_blade22", "ITEMS_GOF3", 15, TGT_OFFICER, B_ORDINARY, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 450);
	n = initStdBlade(n, "GOF_blade23", "ITEMS_GOF3", 16, TGT_OFFICER, B_ORDINARY, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 650);
	n = initStdBlade(n, "GOF_blade27", "ITEMS_GOF8", 3, TGT_OFFICER, B_EXCELLENT, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 5000);
	n = initStdBlade(n, "GOF_cortblade", "ITEMS_GOF8", 3, TGT_OFFICER, B_EXCELLENT, "FencingL", 0, 1.00, 1.00, 1, 1, 1, 12500);
	n = initStdBlade(n, "GOF_blade1", "ITEMS_GOF6", 11, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 25);
	n = initStdBlade(n, "GOF_topor3", "ITEMS_GOF10", 8, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 75);
	n = initStdBlade(n, "GOF_blade3", "ITEMS_GOF6", 8, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 100);
	n = initStdBlade(n, "GOF_blade7", "ITEMS_GOF6", 13, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 125);
	n = initStdBlade(n, "GOF_blade12", "ITEMS_GOF3", 5, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 150);
	n = initStdBlade(n, "GOF_blade18", "ITEMS_GOF3", 11, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 200);
	n = initStdBlade(n, "GOF_blade30", "ITEMS_GOF10", 2, TGT_OFFICER, B_POOR, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 300);
	n = initStdBlade(n, "GOF_blade31", "ITEMS_GOF10", 3, TGT_OFFICER, B_GOOD, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 400);
	n = initStdBlade(n, "GOF_blade24", "ITEMS_GOF8", 5, TGT_OFFICER, B_GOOD, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 750);
	n = initStdBlade(n, "GOF_blade25", "ITEMS_GOF8", 1, TGT_OFFICER, B_GOOD, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 850);
	n = initStdBlade(n, "GOF_blade34", "ITEMS_GOF10", 5, TGT_OFFICER, B_GOOD, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 1000);
	n = initStdBlade(n, "GOF_blade26", "ITEMS_GOF8", 2, TGT_OFFICER, B_GOOD, "FencingS", 0, 1.00, 1.00, 1, 1, 1, 1250);
	n = initStdBlade(n, "GOF_blade10", "ITEMS_GOF3", 3, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 150);
	n = initStdBlade(n, "GOF_blade35", "ITEMS_GOF10", 10, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 200);
	n = initStdBlade(n, "GOF_blade11", "ITEMS_GOF3", 4, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 250);
	n = initStdBlade(n, "GOF_blade13", "ITEMS_GOF3", 6, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 300);
	n = initStdBlade(n, "GOF_topor1", "ITEMS_GOF10", 6, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 325);
	n = initStdBlade(n, "GOF_blade15", "ITEMS_GOF3", 8, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 350);
	n = initStdBlade(n, "GOF_blade16", "ITEMS_GOF3", 9, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 400);
	n = initStdBlade(n, "GOF_blade17", "ITEMS_GOF3", 10, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 450);
	n = initStdBlade(n, "GOF_blade20", "ITEMS_GOF3", 13, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 500);
	n = initStdBlade(n, "GOF_blade21", "ITEMS_GOF3", 14, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 550);
	n = initStdBlade(n, "GOF_blade33", "ITEMS_GOF10", 9, TGT_OFFICER, B_ORDINARY, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 650);
	n = initStdBlade(n, "GOF_blade28", "ITEMS_GOF10", 16, TGT_OFFICER, B_GOOD, "FencingH", 0, 1.00, 1.00, 1, 1, 1, 1500);
