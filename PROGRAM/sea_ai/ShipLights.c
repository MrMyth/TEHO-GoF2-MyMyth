void InitShipLights()
{
	...
	rlights.flare.light.range = 3;
	rlights.flare.light.Attenuation0 = 0.0;
	rlights.flare.light.Attenuation1 = 0.3;
	rlights.flare.light.Attenuation2 = 0.0;
	rlights.flare.Oscillator1.Flicker = 1.0;
	rlights.flare.Oscillator1.Freq = 1.0;
	rlights.flare.Oscillator2.Flicker = 0.7;
	rlights.flare.Oscillator2.Freq = 3.0;
	rlights.flare.corona.r = 0.7;
	rlights.flare.corona.g = 0.35;
	rlights.flare.corona.b = 0.35;
	rlights.flare.corona.subtexture = 0;
	rlights.flare.corona.Range = 3;
	rlights.flare.corona.Size = 0.5;
	rlights.flare.SunRoadFlareFadeDistance = 900.0;
}