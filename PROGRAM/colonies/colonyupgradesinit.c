...
void ColonyUpgradesInit()
{
	...
	ColonyUpgrades[UPGRADE_WHEAT].l1.text = "Пшеничные поля увеличивают прирост продовольствия в колонии.";
	...
	ColonyUpgrades[UPGRADE_PIER].l1.text = "Рыболовецкие причалы увеличивают прирост продовольствия в колонии.";
	...
	ColonyUpgrades[UPGRADE_MILL].l1.text = "Мельница увеличивает прирост продовольствия в колонии.";
	...
	ColonyUpgrades[UPGRADE_SHIPYARD].l1.text = "Позволяет строить на колонии корабли вплоть до 5-го класса.";
	ColonyUpgrades[UPGRADE_SHIPYARD].l2.text = "Позволяет строить на колонии корабли вплоть до 4-го класса.";
	ColonyUpgrades[UPGRADE_SHIPYARD].l3.text = "Позволяет строить на колонии корабли вплоть до 3-го класса.";
	...
	ColonyUpgrades[UPGRADE_ACADEMY].l1.text = "Академия позволяет тренировать матросов и офицеров.";
	...
	ColonyUpgrades[UPGRADE_HUTS].l1.text = "Бараки позволяют тренировать матросов и офицеров, а так же увеличивают лояльность населения.";
	...
	ColonyUpgrades[UPGRADE_STOREHOUSE].l1.text = "Склады позволяют хранить большее количества товара в колонии.";
	...
	ColonyUpgrades[UPGRADE_FORT].colonylevel = 1;//для каждого уровня
	...
	ColonyUpgrades[UPGRADE_FORT].l1.text = "Позволяет устанавливать на защитных укреплениях колонии пушки калибром до 32 фунтов.";
	ColonyUpgrades[UPGRADE_FORT].l2.text = "Позволяет устанавливать на защитных укреплениях колонии кульверины и пушки калибром до 36 фунтов.";
	ColonyUpgrades[UPGRADE_FORT].l3.text = "Позволяет устанавливать на защитных укреплениях колонии кульверины, мортиры и пушки калибром до 42 фунтов.";
	ColonyUpgrades[UPGRADE_FORT].l4.text = "Позволяет устанавливать на защитных укреплениях колонии кульверины, мортиры и пушки калибром до 48 фунтов.";
	...
	ColonyUpgrades[UPGRADE_CHURCH].l1.text = "Церковь увеличивает лояльность населения колонии.";
	...
	ColonyUpgrades[UPGRADE_EXPEDITION].l1.text = "Экспедиция позволяет определить есть ли на острове залежи золота или серебра.";
	...
	ColonyUpgrades[UPGRADE_GOLDMINES].l1.text = "Золотые шахты позволяют колонии получать дополнительную прибыль.";
	...
	ColonyUpgrades[UPGRADE_SILVERMINES].l1.text = "Серебрянные шахты позволяют колонии получать дополнительную прибыль.";
}
