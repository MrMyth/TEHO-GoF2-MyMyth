int LocationInitSantaQuiteria(int n)
{
	...
	// Мыс 71
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore71";
	locations[n].id.label = "Shore71";
	locations[n].image = "loading\outside\harbor3.tga";
	locations[n].worldmap = "SantaQuiteria";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "SantaQuiteria";
	...
	locations[n].reload.l1.go = "SantaQuiteria_Jungle_03";
	...
	// Джунгли
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaQuiteria_Jungle_03";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Shore71";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	...
	// Вход в пещеру
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaQuiteria_CaveEntrance";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "SantaQuiteria_Cave";
	locations[n].reload.l1.emerge = "reload1";
	...
	// Пещера
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaQuiteria_Cave";
...
*/	
	...
	// Джунгли
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    locations[n].id = "SantaQuiteria_jungle_01";
	locations[n].id.label = "Jungle";
	locations[n].image = "loading\outside\jungle_" + rand(3) + ".tga";
 	//Sound
	locations[n].type = "jungle";
	...
	// Джунгли
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "SantaQuiteria_Jungle_02";
	locations[n].id.label = "Jungle";
	locations[n].image = "loading\outside\jungle_" + rand(3) + ".tga";
	//Sound
	locations[n].type = "jungle";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Shore72";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	...
	// Бухта 72
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore72";
	locations[n].id.label = "Shore72";
	locations[n].image = "loading\outside\harbor3.tga";
	locations[n].worldmap = "Shore72";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "SantaQuiteria";
	locations[n].onUninhabitedIsland = true;
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "SantaQuiteria_Jungle_02";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2;
	...
	// Бухта70
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "Shore70";
	locations[n].id.label = "Shore70";
	locations[n].image = "loading\outside\harbor3.tga";
	locations[n].worldmap = "Shore70";
	//Sound
	locations[n].type = "seashore";
	locations[n].islandId = "SantaQuiteria";
	locations[n].onUninhabitedIsland = true;
