...
{	
	...
	locations[n].houseEnc = true;   //to_do Хомо. этот тоже надо вернуть, генерит хозяев домов
	//Models
	//Always
	locations[n].models.always.town = "Bridgetown";
	locations[n].models.always.reflect = "Bridgetown_reflect";
	...
	//Day
	locations[n].models.day.fonar = "Bridgetown_fd";
	locations[n].models.day.charactersPatch = "Bridgetown_patch_day";
	locations[n].models.day.rinok = "Bridgetown_rinok";
	//Night
	locations[n].models.night.fonar = "Bridgetown_fn";
	...
	locations[n].reload.l1.go = "Barbados";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Bridgetown_tavern";
	...
	locations[n].reload.l1.go = "Bridgetown_townhall";
	locations[n].reload.l1.emerge = "reload3";
	locations[n].reload.l1.autoreload = "0";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Bridgetown_brothel";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Barbados_jungle_02";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Bridgetown_Plantation";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Mayak2";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "0";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Barbados_Cave";
	locations[n].reload.l1.emerge = "reload1";
	locations[n].reload.l1.autoreload = "0";
...
*/	
	...
	//Reload map
	locations[n].reload.l1.name = "reload1";
	locations[n].reload.l1.go = "Barbados_CaveEntrance";
	locations[n].reload.l1.emerge = "reload1";
	...
	//Reload map
	locations[n].reload.l1.name = "reload1_back";
	locations[n].reload.l1.go = "Barbados_jungle_03";
	locations[n].reload.l1.emerge = "reload2";
	locations[n].reload.l1.autoreload = "1";
	locations[n].reload.l1.label = "Jungle";
	locations[n].locators_radius.reload.reload1_back = 2;
