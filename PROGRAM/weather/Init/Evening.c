...
// Evening1 19 ?????
	...
	Weathers[n].Sea2.WaterColor = argb(0, 0, 60, 84);
	Weathers[n].Sea2.SkyColor = argb(0, 205, 200, 200);
...
// Eveninng4
	...
	Weathers[n].Sea2.BumpScale = 0.035; //?????? ?????
	Weathers[n].Sea2.PosShift = 1.4; //??????????????? ????
	Weathers[n].Sea2.WaterColor = argb(0, 0, 10, 30);
