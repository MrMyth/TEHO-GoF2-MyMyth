	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ShipWreck_10":
			...
			else
			{
				...
				{
					AddQuestUserData("ShipWrecked", "sText", "потерпевшего крушение");
				}
				// <-- belamour
			}
		break;							
		...
		case "Convict_11_2":
			...
			link.l1 = "Alright, wait for me at " + XI_ConvertString(pchar.GenQuest.Convict.ShoreLocation + "Gen") + ". You'll have your ship by the midnight. And don't try to fool me!";
		...
		case "Convict_13_2":
			...
			link.l1 = "Then go " + XI_ConvertString(pchar.GenQuest.Convict.ShoreLocation + "Dat") + ". I'll send a longboat for you around the midnight.";
...
//			bQuestDisableMapEnter = true;
		...
		case "CaptainComission_310":
			dialog.text = "I will take your vessel and leave you at " + XI_ConvertString(pchar.GenQuest.CaptainComission.ShoreLocation + "Gen") + ".";
...
//				link.l1.go = "ChurchGenQuest1_DialogShip_5_2_1"; // Сваливаем, поверили ему
		...
		case "PiratesOnUninhabited_11":
			...
			if(!CheckAttribute(PChar, "GenQuest.PiratesOnUninhabited.TreasureMap"))
			{
				if(CheckAttribute(PChar, "GenQuest.PiratesOnUninhabited.Shipwrecked"))
				{
					...
					{
						AddQuestUserData(sTitle, "sText", "потерпевшего крушение пиратского");
					}
					// <-- belamour gen
				}
				else
			...
			AddQuestUserData(sTitle, "count", PChar.GenQuest.PiratesOnUninhabited.PiratesCount + " моряков"); // belamour gen
		...
		case "PiratesOnUninhabited_45":
			...
			{
				AddQuestUserData(sTitle, "count", PChar.GenQuest.PiratesOnUninhabited.PiratesCount + " моряка");
			}
			// <-- belamour
...
String Convict_GetStringNum(int iCQTY)
{
	...
	switch(iCQTY)
	{
		case 2: ConvictStr = "двое"; break;
		case 3: ConvictStr = "трое"; break;
		case 4: ConvictStr = "четверо"; break;
		case 5: ConvictStr = "пятеро"; break;
		case 6: ConvictStr = "шестеро"; break;
		case 7: ConvictStr = "семеро"; break;
	}
	return ConvictStr;
}
// <-- gen