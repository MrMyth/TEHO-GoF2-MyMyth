...
//-----------------------------------------пиратская сага----------------------------------------------------
		...
		case "CapComission2_12":
			...
			AddQuestUserData("CaptainComission1", "sName", "Джекман")); // belamour gen
    	...
    	break;
		case "AngryRepeat_2":
            dialog.text = RandPhraseSimple("It's over, no talking." "I don't want to talk with you anymore so you'd better don't bother me.");
