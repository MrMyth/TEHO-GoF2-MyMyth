...
//--------------------------------------------Похититель------------------------------------------------------
		...
		case "Marginpassenger_offer_1":
			...
			AddQuestUserData("Marginpassenger", "sName", "Захарии Марлоу")); // belamour gen : как-то странно, наводку дает Захар, а в сж Добряк дефолтом
		...
		case "Marginpassenger_offer_2":
			...
			AddQuestUserData("Marginpassenger", "sName", "Захарии Марлоу")); // belamour gen 
