...
//--------------------------------------------Похититель------------------------------------------------------
		...
		case "Marginpassenger_offer_1":
			...
			AddQuestUserData("Marginpassenger", "sName", "Добряка Жака"));
