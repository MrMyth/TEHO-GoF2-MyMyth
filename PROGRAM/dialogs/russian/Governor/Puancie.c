...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "patria_27":
			dialog.text = "I suppose you remember my discussion with Monsieur Forget about Saint-Martin? We need to assure the baron that the colony has been inspected, and you will go to Curacao, to Willemstadt, to the Company director Peter Stuyvesant. He is there right now, and will be for three more weeks. Also, you'll need to escort the fluyt with the Company's goods to Curacao and give mynheer Stuyvesant a letter from me.";
			link.l1 = "Are these all the tasks?";
			link.l1.go = "patria_28";
		break;
		case "patria_28":
			dialog.text = "Yes, captain. Inform me about mynheer Stuyvesant's reply. We should be just in time before Monsieur Forget will return from his trip to Martinique and Guadelupa, and he will finally be able to visit Saint-Martin, which he really wants to visit.";
