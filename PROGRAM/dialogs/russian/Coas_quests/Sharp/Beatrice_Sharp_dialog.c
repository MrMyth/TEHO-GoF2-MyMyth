...
//grotto - dialog 2
		...
		case "6":
			...
			link.l1 = "Slick. You made one wrong assumption though - while I was indeed looking for the other half of the map, it was in fact your half I was searching for. I already had my piece of it by then, and that I got in the same manner you received yours. What I believed to be your half, I actually bought from that innkeeper - at an utterly insane price I might add. Remind me to have a word with him about selling stolen merchandise without a discount...";
			link.l1.go = "7";
		break;

		case "7":
			dialog.text = "But, that means you're...";
			link.l1 = "The one and only. I am at your service, dear step-sister. It is sad that we should be brought together only by such regrettably absurd chance, but I'm more than happy to see you, nonetheless.";
			link.l1.go = "8";
			link.l2 = "Your step-brother. And now, sister dearest, I'm afraid you'll have to die, since I have no intention of sharing my treasure with anyone but me and, well, me. It's time to end our little reunion.";
		...
		case "11":
			...
			link.l1 = "Libertania... I like the sound of that. Even if it's the death of me, you can count me in, sister!";
			link.l1.go = "12";
...
//after advisor quest done
		...
		case "18":
			dialog.text = "What a nice thing to say, Blaze. I didn't think you cared much...";
...
//at pirate meeting
		...
		case "22":
			dialog.text = "You doubt. You doubt Blaze and the reality of his dreams. Well let me tell you - if there is anyone who can make such dreams real in this room, it's him. You hesitate. You hesitate because it seems like an impossible goal. But consider this - a chance to change the world is a rare thing. Precious few people ever get such a chance, and nobody ever gets it twice. Right here, right now, you have that chance. Take it, and use it to make a name for yourself that will live a thousand years after your corpse is one with the sea! Take it, and show all those bastards what it really means to be a free captain...";
			link.l1 = "...";
			link.l1.go = "Exit";
		break;
...
//after pirate meeting
		...
		case "25":
			dialog.text = "Well well, Blaze. Looks like you've done it. Congratulations!";
			link.l1 = "WE did it, Beatrice, WE. If it hadn't been for your encouragement, they'd have just walked out on me.";
			link.l1.go = "26";
		break;

		case "26":
			dialog.text = "Well, if you insist. So... what do you suppose we should do now, dear step-brother?";
