...
// Jason-------------------------------------------------Сага----------------------------------------------
		...
		case "GenQuest_Church_1_Start_2":
			...
			dialog.text = "Oh! Good... But, again, this is a very delicate business... Some time ago father superior " + PChar.GenQuest.ChurchQuest_1.ToName + " from " + XI_ConvertString("Colony" + PChar.GenQuest.ChurchQuest_1.ToColony + "Gen") + " on " + XI_ConvertString(PChar.GenQuest.ChurchQuest_1.ToIsland + "Voc") + " took for me for a while a few theological labours and ancient manuscripts from a church library. Because a request was supported by the requirement of archbishop not to prevent to distribution of lovely light of knowledge, I couldn't refuse, even though I presumed that difficulties of sea voyages wouldn't allow him to return manuscripts in time... Could you assist me with solving this problem?";
