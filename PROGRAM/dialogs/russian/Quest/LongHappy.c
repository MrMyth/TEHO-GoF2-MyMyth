...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "Svenson_3":
			dialog.text = "I sent Gladys back to Blueveld on a merchant ship - she doesn't approve of all these dashing parties. Joahnna couldn't arrive - oh, I had no time to tell you on Martinique! Just imagine - in my old age, I will become a legal father, what's about that? Look, if you hurry, our offsprings will be almost the same age, hahaha!";
		...
		break;
		case "Svenson_39":
			dialog.text = "That's all. Well, it could be worse.";
		...
		break;
		case "Tonzag_4_1":
			dialog.text = "What a great celebration, captain!";
			link.l1 = "Drink and have fun!";
			link.l1.go = "Tonzag_4";
		break;
		// Бейкер
