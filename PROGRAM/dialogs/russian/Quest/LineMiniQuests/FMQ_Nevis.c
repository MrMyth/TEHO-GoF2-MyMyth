...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "seafox_1":
			dialog.text = "Let me briefly explain the situation. Me and four of my subordinates were sailing from St. Jones to the shores of Saint-Martin when a storm hit us hard. It didn't last long but it was enough for our old tub to spring a leak. We had to change our course and make a stop here. Turned out that repairing our vessel will take a lot of time which we do not posses at the moment\nWe are in a rush and got to make to Grand Case beach of Saint-Martin. Help us out captain and I will make it worth your while. It's just a two days voyage for a generous pay.";
