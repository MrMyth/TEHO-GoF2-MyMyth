...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ecliaton_cap_7":
			...
			link.l1 = "Yes. The 'Eclatant' is once again under my command. We are going to storm Philipsburg. The Governor General has tasked us with clearing out the Dutch from Saint-Martin.";
