...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LicenceOk":
			...
			if (pchar.location != "Minentown_town" && pchar.location != "Minentown_mine" && findsubstr(pchar.location.from_sea, "_town" , 0) == -1) //если причалил не в городе 300912
			{ // лесник . добавил рудник в искл. 
