			...
			else
			{
                ...
                {//->
                    ...
                    else
                    {
						...
						{
							link.l11 = "On " + XI_ConvertString(PChar.GenQuest.PiratesOnUninhabited.StartShore + "Gen") + " I met pirates. All " + PChar.GenQuest.PiratesOnUninhabited.PiratesCount + " are on board at the moment. I want to turn them to the authorities.";
						...
						if(CheckAttribute(pchar,"GenQuest.ShipWreck") && pchar.GenQuest.ShipWreck == "SailorsOnShore" && GetQuestPastDayParam("GenQuest.ShipWreck") < 25  && sti(npchar.nation) == sti(pchar.GenQuest.ShipWreck.Nation))
						{
							if(!CheckAttribute(pchar,"GenQuest.ShipWreck.SpeakMayor"))
							{
								...
								{
									link.l13 = "On " + XI_ConvertString(pchar.GenQuest.ShipWreck.Shore + "Gen") + " I met captain " + pchar.GenQuest.ShipWreck.Name + " and his sailors who were put ashore by pirate " + pchar.GenQuest.ShipWreck.BadName + ". " +
								...
								{
									link.l13 = "On " + XI_ConvertString(pchar.GenQuest.ShipWreck.Shore + "Gen") + " I met sailors from the wrecked ship '" + pchar.GenQuest.ShipWreck.ShipTypeName + "' with their captain. " +
		...
		case "node_1":
            ...
            {//->
                ...
                else
                {
					...
					if(CheckAttribute(PChar, "GenQuest.JusticeOnSale.MayorWait") && CheckAttribute(PChar, "GenQuest.JusticeOnSale.CityId") && NPChar.location == PChar.GenQuest.JusticeOnSale.CityId + "_townhall")
					{
						link.l15 = "Milord, I have located a gang of smugglers, whose ringleader have been recently caught by the guards. Now they are planning to arrange his escape. Their ship '" + PChar.GenQuest.JusticeOnSale.ShipName + "' is moored at " + XI_ConvertString(PChar.GenQuest.JusticeOnSale.ShoreId + "Gen") + "."; // belamour gen
						link.l15.go = "JusticeOnSale_1";
					}
					//<-- Правосудие на продажу
        			if (GetPrisonerQty() > 0)
...
//<-- осады homo
		...
		case "JusticeOnSale_4":
			dialog.text = "You're correct, captain! We just can't leave it like that! I would ask you to head to " + XI_ConvertString(PChar.GenQuest.JusticeOnSale.ShoreId + "Dat") + ", find their ship and take their whole gang under arrest! If they resist - use force, do not hesitate!"; // belamour gen
			link.l1 = "Allow me to take my leave.";
